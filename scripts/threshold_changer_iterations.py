...
input_dir = "../data/nab_tuned_results_noCDD_iterations/"
...
for iteration in range(1, no_of_iterations+1):
    model_summary_file = model_summary_prefix + "_iteration_" + str(iteration) + ".csv"
    model_dataframe = pandas.read_csv(model_summary_file, index_col="file")

    iteratoin_input_dir = input_dir + "/iteration_"+str(iteration) + "/"
